  ...
  return (
    <section className="text-xl text-center max-w-4xl mx-auto my-10 py-5 dark:text-slate-100 border dark:border-slate-700 rounded">
        <div className="my-5">
            ...
            { data && <p>Your Order ID: {data.id}</p> }
        </div>
        <div className="my-5">
            <p>Your order is confirmed.</p>
            { data && <p>Please check your mail ({data.user_email}) for the movie.</p> }
            <p className="my-5 text-green-500 font-semibold">Payment Successful! ✅</p>
        </div>
